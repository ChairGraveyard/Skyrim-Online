...
namespace Messages
{
    ...
    class GameCli_PlayerAddRecv : public Packet
    {
    public:
        GameCli_PlayerAddRecv() {}
        ~GameCli_PlayerAddRecv() {}
    ...
    class GameCli_PlayerRemoveRecv : public Packet
    {
    public:
        GameCli_PlayerRemoveRecv() {}
        ~GameCli_PlayerRemoveRecv() {}
    ...
    class CliGame_PlayerInitializeSend : public Packet
    {
    public:
        CliGame_PlayerInitializeSend() {}
        ~CliGame_PlayerInitializeSend() {}
